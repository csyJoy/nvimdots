...
function mapping.lsp(buf)
	local map = {
		...
		["n|gd"] = map_cr("Lspsaga finder def"):with_buffer(buf):with_desc("lsp: Preview definition"),
		["n|gD"] = map_cr("Lspsaga goto_definition"):with_buffer(buf):with_desc("lsp: Goto definition"),
		["n|gr"] = map_cr("Lspsaga finder ref"):with_buffer(buf):with_desc("lsp: Show reference"),
		["n|gi"] = map_cr("Lspsaga finder imp"):with_buffer(buf):with_desc("lsp: Show implementations"),
