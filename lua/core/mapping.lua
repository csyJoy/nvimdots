...
local core_map = {
	...
	["n|<C-h>"] = map_cmd("<CMD>NavigatorLeft<CR>"):with_silent():with_noremap():with_desc("window: Focus Left"),
	["n|<C-l>"] = map_cmd("<CMD>NavigatorRight<CR>"):with_silent():with_noremap():with_desc("window: Focus Right"),
	["n|<C-k>"] = map_cmd("<CMD>NavigatorUp<CR>"):with_silent():with_noremap():with_desc("window: Focus Up"),
	["n|<C-j>"] = map_cmd("<CMD>NavigatorDown<CR>"):with_silent():with_noremap():with_desc("window: Focus Down"),
	["t|<C-h>"] = map_cmd("<CMD>NavigatorLeft<CR>"):with_silent():with_noremap():with_desc("window: Focus Left"),
	["t|<C-l>"] = map_cmd("<CMD>NavigatorRight<CR>"):with_silent():with_noremap():with_desc("window: Focus Right"),
	["t|<C-k>"] = map_cmd("<CMD>NavigatorUp<CR>"):with_silent():with_noremap():with_desc("window: Focus Up"),
	["t|<C-j>"] = map_cmd("<CMD>NavigatorDown<CR>"):with_silent():with_noremap():with_desc("window: Focus Down"),
